...
const findById = (id) => {
    ...
    const { comment } = entry, diaryEntry = __rest(entry, ["comment"]);
    return diaryEntry;
};
exports.findById = findById;
const getEntriesWithoutSensitiveInfo = () => diaries.map(({ id, date, weather, visibility }) => { return { id, date, weather, visibility }; });
